...
![steps(2,start)]({{ site.imageurl }}/assets/images/2016/steps(2,start).png)![steps(4,end)]({{ site.imageurl }}/assets/images/2016/steps(4,end).png)

（上图分别为steps\(2,start\)和steps\(4,end\)）
